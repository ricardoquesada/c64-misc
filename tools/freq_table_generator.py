...
def run(basefreq, octaves, steps, phi, onlyfreq):
    ...
    if onlyfreq:
        ...
        for o in range(0, octaves):
            for i in range(0, steps):
                sys.stdout.write("%8.2f" % __freqs[i + o * steps])
            sys.stdout.write("; %d \n" % o)
    else:
        sys.stdout.write("freq_table_lo:\n")
        for o in range(0, octaves):
...
if __name__ == "__main__":
    ...
    argv = sys.argv[1:]
    try:
        opts, args = getopt.getopt(argv, "b:o:s:f", ["basefreq=", "octaves=", "steps=", "freq"])
        for opt, arg in opts:
            if opt in ("-o", "--octaves"):
                octaves = int(arg)
            elif opt in ("-s", "--steps"):
    ...
    run(basefreq, octaves, steps, phi, onlyfreq)
